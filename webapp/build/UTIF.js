  ...
  (function (UTIF, pako) {
    ...
    (function () {
      ...
      (function () {
          ...
          for (b = 0; b < k; b++) {
            for (B = 0; B < a[b]; B++) {
              ...
              for (e.push(l); e.length <= b; )
                e.push((r = { children: [], index: 0 })),
                  (l.children[l.index] = r.children),
                  (l = r);
              f++;
            }
            b + 1 < k &&
        ...
        function X(a, d, f, e, b, B, k, l, r) {
          ...
          for (var S, T; G < O; ) {
            ...
            (y = N(a, d)) &&
              y.f &&
              ((0, _util.warn)(
                "decodeScan - unexpected MCU data, current marker is: " + y.f
              ),
              (d = y.offset));
            y = y && y.F;
          ...
          (y = N(a, d)) &&
            y.f &&
            ((0, _util.warn)(
              "decodeScan - unexpected Scan data, current marker is: " + y.f
            ),
            (d = y.offset));
          return d - v;
        }
            ...
            for (var k = 0; k < f; k++) {
              ...
              for (n = 0; 8 > n; ++n)
                (c = r[n]),
                  ...
                  0 === (C | w | p | m | t | g | u)
                    ? ((c = (5793 * c + 8192) >> 14),
                      (c = -2040 > c ? 0 : 2024 <= c ? 255 : (c + 2056) >> 4),
                      (q[l + n] = c),
                      (q[l + n + 8] = c),
                      (q[l + n + 16] = c),
                      (q[l + n + 24] = c),
                    ...
                    : ((v = (5793 * c + 2048) >> 12),
                      ...
                      (v = ((v + z + 1) >> 1) + 4112),
                      (z = v - z),
                      (c = (3784 * x + 1567 * A + 2048) >> 12),
                      (x = (1567 * x - 3784 * A + 2048) >> 12),
                      (A = c),
                      (m = (m + t + 1) >> 1),
                      (t = m - t),
                      (u = (u + p + 1) >> 1),
                      ...
                      (p = A + m),
                      (m = A - m),
                      (c = 16 > c ? 0 : 4080 <= c ? 255 : c >> 4),
                      (C = 16 > C ? 0 : 4080 <= C ? 255 : C >> 4),
                      (w = 16 > w ? 0 : 4080 <= w ? 255 : w >> 4),
                      (p = 16 > p ? 0 : 4080 <= p ? 255 : p >> 4),
                      (m = 16 > m ? 0 : 4080 <= m ? 255 : m >> 4),
                      (t = 16 > t ? 0 : 4080 <= t ? 255 : t >> 4),
                      (g = 16 > g ? 0 : 4080 <= g ? 255 : g >> 4),
                      (u = 16 > u ? 0 : 4080 <= u ? 255 : u >> 4),
                      (q[l + n] = c),
                      (q[l + n + 8] = C),
                      (q[l + n + 16] = w),
                      (q[l + n + 24] = p),
        ...
        g.prototype = {
          parse: function (a) {
            ...
            function f() {
              ...
              c &&
                c.f &&
                ((0, _util.warn)(
                  "readDataBlock - incorrect length, current marker is: " + c.f
                ),
                (b = c.offset));
              b = a.subarray(k, b);
              k += b.length;
            ...
            function e(a) {
              for (
                var b = Math.ceil(a.v / 8 / a.s),
                  c = Math.ceil(a.g / 8 / a.u),
                  d = 0;
                d < a.b.length;
                d++
              ) {
          ...
          I: function (a) {
            for (var d, f, e, b = 0, g = a.length; b < g; b += 3)
              (d = a[b]),
                (f = a[b + 1]),
                (e = a[b + 2]),
                (a[b] = d - 179.456 + 1.402 * e),
                (a[b + 1] = d + 135.459 - 0.344 * f - 0.714 * e),
                (a[b + 2] = d - 226.816 + 1.772 * f);
            return a;
          },
          K: function (a) {
            for (var d, f, e, b, g = 0, k = 0, l = a.length; k < l; k += 4)
              (d = a[k]),
                (f = a[k + 1]),
                (e = a[k + 2]),
                (b = a[k + 3]),
                (a[g++] =
                  -122.67195406894 +
                  f *
                    (-6.60635669420364e-5 * f +
                      4.37130475926232e-4 * e -
                      5.4080610064599e-5 * d +
                      4.8449797120281e-4 * b -
                      0.154362151871126) +
                  e *
                    (-9.57964378445773e-4 * e +
                      8.17076911346625e-4 * d -
                      0.00477271405408747 * b +
                      1.53380253221734) +
                  d *
                    (9.61250184130688e-4 * d -
                      0.00266257332283933 * b +
                      0.48357088451265) +
                  b * (-3.36197177618394e-4 * b + 0.484791561490776)),
                (a[g++] =
                  107.268039397724 +
                  f *
                    (2.19927104525741e-5 * f -
                      6.40992018297945e-4 * e +
                      6.59397001245577e-4 * d +
                      4.26105652938837e-4 * b -
                      0.176491792462875) +
                  e *
                    (-7.78269941513683e-4 * e +
                      0.00130872261408275 * d +
                      7.70482631801132e-4 * b -
                      0.151051492775562) +
                  d *
                    (0.00126935368114843 * d -
                      0.00265090189010898 * b +
                      0.25802910206845) +
                  b * (-3.18913117588328e-4 * b - 0.213742400323665)),
                (a[g++] =
                  -20.810012546947 +
                  f *
                    (-5.70115196973677e-4 * f -
                      2.63409051004589e-5 * e +
                      0.0020741088115012 * d -
                      0.00288260236853442 * b +
                      0.814272968359295) +
                  e *
                    (-1.53496057440975e-5 * e -
                      1.32689043961446e-4 * d +
                      5.60833691242812e-4 * b -
                      0.195152027534049) +
                  d *
                    (0.00174418132927582 * d -
                      0.00255243321439347 * b +
                      0.116935020465145) +
                  b * (-3.43531996510555e-4 * b + 0.24165260232407));
            return a.subarray(0, g);
          },
          J: function (a) {
            for (var d, f, e, b = 0, g = a.length; b < g; b += 4)
              (d = a[b]),
                (f = a[b + 1]),
                (e = a[b + 2]),
                (a[b] = 434.456 - d - 1.402 * e),
                (a[b + 1] = 119.541 - d + 0.344 * f + 0.714 * e),
                (a[b + 2] = 481.816 - d - 1.772 * f);
            return a;
          },
          H: function (a) {
            for (
              var d, f, e, b, g = 0, k = 1 / 255, l = 0, r = a.length;
              l < r;
              l += 4
            )
              (d = a[l] * k),
                ...
                (a[g++] =
                  ...
                  d *
                    (-4.387332384609988 * d +
                      54.48615194189176 * f +
                      18.82290502165302 * e +
                      212.25662451639585 * b -
                      285.2331026137004) +
                  f *
                    (1.7149763477362134 * f -
                      5.6096736904047315 * e -
                      17.873870861415444 * b -
                      5.497006427196366) +
                  e *
                    (-2.5217340131683033 * e -
                      21.248923337353073 * b +
                      17.5119270841813) -
                  b * (21.86122147463605 * b + 189.48180835922747)),
                (a[g++] =
                  255 +
                  d *
                    (8.841041422036149 * d +
                      60.118027045597366 * f +
                      6.871425592049007 * e +
                      31.159100130055922 * b -
                      79.2970844816548) +
                  f *
                    (-15.310361306967817 * f +
                      17.575251261109482 * e +
                      131.35250912493976 * b -
                      190.9453302588951) +
                  e *
                    (4.444339102852739 * e +
                      9.8632861493405 * b -
                      24.86741582555878) -
                  b * (20.737325471181034 * b + 187.80453709719578)),
                (a[g++] =
                  255 +
                  d *
                    (0.8842522430003296 * d +
                      8.078677503112928 * f +
                      30.89978309703729 * e -
                      0.23883238689178934 * b -
                      14.183576799673286) +
                  f *
                    (10.49593273432072 * f +
                      63.02378494754052 * e +
                      50.606957656360734 * b -
                      112.23884253719248) +
                  e *
                    (0.03296041114873217 * e +
                      115.60384449646641 * b -
                      193.58209356861505) -
                  b * (22.33816807309886 * b + 180.12613974708367));
            return a.subarray(0, g);
          },
    ...
    UTIF.decode._decompress = function (
      ...
      if (false) {
        ...
        UTIF.decode._decodeG3(data, off, len, tgt, toff, img.width, fo);
      else if (cmpr == 4)
    ...
    UTIF.decode._decodeNewJPEG = function (img, data, off, len, tgt, toff) {
      ...
      if (img["t262"][0] == 32803 || img["t262"][0] == 34892) {
        // lossless JPEG and lossy JPEG (used in DNG files)
    ...
    UTIF._readIFD = function (bin, data, offset, ifds, depth, debug) {
      ...
      for (var i = 0; i < cnt; i++) {
        ...
        if (type == 10) {
          for (var j = 0; j < num; j++)
            arr.push(
              bin.readInt(data, voff + j * 8) /
                bin.readInt(data, voff + j * 8 + 4)
            );
        }
        if (type == 11) {
          for (var j = 0; j < num; j++)
        ...
        // ifd["t258"]=[12];  ifd["t259"]=[32767];  ifd["t273"]=[offset+arr[0]];  ifd["t277"]=[1];  ifd["t279"]=[1];  ifd["t33421"]=[2,2];  ifd["t33422"]=[0,1,1,2];
          ...
          for (var j = 0; j < oarr.length; j++)
            UTIF._readIFD(bin, data, oarr[j], subfd, depth + 1, debug);
    ...
    UTIF.LosslessJpegDecode = (function () {
      ...
      l.prototype = {
        ...
        e: function () {
          ...
          for (var Y = 0; Y < 16; Y++)
            for (var B = 0; B < E[Y]; B++) i.s(s, this.z.i(), Y + 1);
          return Z + 17;
        },
        W: function (Z) {
          while (Z > 0) Z -= this.e();
