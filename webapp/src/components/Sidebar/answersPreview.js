        ...
        <>
            ...
            >
                <AlertDialogContent borderRadius="10px">
                    ...
                    >
                        <Text marginLeft="1em" size="sm">Preview</Text>
                    </AlertDialogHeader>
                    <AlertDialogBody space={2} paddingTop="2em" paddingBottom="1em">
                        ...
                        <HStack>
                            <Flex
                                ...
                                <Text size="lg" fontWeight="bold" marginTop="1em">NAFLD Activity Score (NAS)</Text>
                            ...
                            <Flex
                                ...
                                <HStack>
                                    <Button size="sm" width="10em" color="#3965C5" backgroundColor="white" border="1px solid #3965C5" onClick={() => onClose()}>
                                        Cancel
                                    </Button>
                                    <Button size="sm" width="10em" color="white" backgroundColor="#3965C5" _hover={{ bg: "#66a3ff" }}>
                                        Submit & Next
                                    </Button>
                                </HStack>
                            </Flex>
                        ...
                        <Flex
                            ...
                            <Text size="lg" fontWeight="bold" marginTop="1em">Fibrosis Stage</Text>
