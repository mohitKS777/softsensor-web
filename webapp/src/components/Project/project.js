        ...
        <>
            ...
            <Box
                ...
                <Flex w="100%" direction="row" marginTop="10px">
                    ...
                    <Spacer />
                    <Search w={200} mr={5} />
                    <IconButton icon={<IoGridOutline color="#3965C5" />} size="xs" border="1px solid #3965C5" marginRight={3} marginTop={4} />
                    <IconButton icon={<BsList color="#3965C5" />} size="xs" border="1px solid #3965C5" marginRight={5} marginTop={4} />
                </Flex>
                <Flex direction="column">
                    <Flex>
                        ...
                        <Button size="md" px={10} mx={4} backgroundColor="#3965C5" color="white">
                            View Reports
                        </Button>
                    </Flex>
                    <HStack>
                        <Text color="#8aaeff" fontSize="sm" marginLeft={9}>
                            Oct 24, 2021 <Icon as={BsCircleFill} marginBottom={1} w={1} h={1} />
                        </Text>
                    ...
                    <Flex>
                                ...
                                <Tr borderBottom="1px solid #3965C5" _hover={{ bg: "#bacfff" }}>
                                    ...
                                    <Td>
                                        <Stack direction="row" style={{ width: "77px" }} justify="end">
                                            <CircularProgressbar value="50" text="50%" styles={buildStyles({ textSize: '30px', pathColor: '#fe740d', textColor: '#fe740d' })} />
                                            <CircularProgressbar value="75" text="75%" styles={buildStyles({ textSize: '30px', pathColor: '#67818d', textColor: '#67818d' })} />
                                        </Stack>
                                    </Td>
                                    <Td>
                                        <Text
                        ...
                        <Box
                            ...
                            <HStack borderBottom="1px solid #3965C5" paddingBottom="5px">
                                ...
                                <Button size="sm" fontWeight="light" variant="unstyled">Add New Member</Button>
                            </HStack>
                            <VStack>
                                <Flex paddingTop="6px" borderBottom="1px solid #3965C5" width="100%" padding="5px">
                                    <Avatar name="Rakesh Gautam" size="sm" marginTop="2px" />
                                    <Flex direction="column" marginLeft="5px">
                                        <Text>Rakesh Gautam</Text>
                                        <Text fontSize="xs" color="#8aaeff">rakesh.gautam@gmail.com</Text>
                                    </Flex>
                                    <Spacer />
                                    <IconButton as={HiOutlineDotsCircleHorizontal} size="xs" backgroundColor="#dddddd" marginTop="7px" />
                                </Flex>
                                <Flex paddingTop="6px" borderBottom="1px solid #3965C5" width="100%" padding="5px">
                                    <Avatar name="Mila Maghudiya" size="sm" marginTop="2px" />
                                    <Flex direction="column" marginLeft="5px">
                                        <Text>Mila Maghudiya</Text>
                                        <Text fontSize="xs" color="#8aaeff">mila.maghudiya@gmail.com</Text>
                                    </Flex>
                                    <Spacer />
                                    <IconButton as={HiOutlineDotsCircleHorizontal} size="xs" backgroundColor="#dddddd" marginTop="7px" />
                                </Flex>
                                <Flex paddingTop="6px" borderBottom="1px solid #3965C5" width="100%" padding="5px">
                                    ...
                                    <Flex direction="column" marginLeft="5px">
                                        ...
                                        <Text fontSize="xs" color="#8aaeff">zoe.margot@gmail.com</Text>
                                    </Flex>
                                    <Spacer />
                                    <IconButton as={HiOutlineDotsCircleHorizontal} size="xs" backgroundColor="#dddddd" marginTop="7px" />
                                </Flex>
                                <Button size="sm" fontWeight="light" variant="unstyled">View More Details</Button>
                            </VStack>
                        </Box>
                    </Flex>
                    <Flex width="60%" direction="column">
                        <Text color="#3965C5" fontWeight="bold" borderBottom="1px solid #3965C5" mx={5} marginTop={7} w="17%">
                            Tasks Submitted
                                ...
                                <Tr borderBottom="1px solid #3965C5" _hover={{ bg: "#bacfff" }}>
                                    ...
                                    <Td justifyContent="center">
                                        <Stack direction="row" style={{ width: "77px" }}>
                                            <CircularProgressbar value="65" text="65%" styles={buildStyles({ textSize: '30px', pathColor: '#67818d', textColor: '#67818d' })} />
                                            <CircularProgressbar value="100" text="100%" styles={buildStyles({ textSize: '30px', pathColor: '#9efadb', textColor: '#9efadb' })} />
                                        </Stack>
                                    </Td>
                                    <Td>
                                        <Text
                    ...
                    <Flex width="60%" direction="column">
                        ...
                        <Tbody>
                                <Tr borderBottom="1px solid #3965C5" _hover={{ bg: "#bacfff" }}>
                                    ...
                                    <Td justifyContent="center">
                                        <Stack direction="row" style={{ width: "77px" }}>
                                            <CircularProgressbar value="100" text="100%" styles={buildStyles({ textSize: '30px', pathColor: '#67818d', textColor: '#67818d' })} />
                                            <CircularProgressbar value="100" text="100%" styles={buildStyles({ textSize: '30px', pathColor: '#9efadb', textColor: '#9efadb' })} />
                                        </Stack>
                                    </Td>
                                    <Td>
